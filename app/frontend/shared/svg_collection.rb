module Shared
  module SVGCollection
    ...
    def trash_icon
      svg(class: "mr-2 h-5 w-5", fill: "currentColor", viewBox: "0 0 20 20", xmlns: xmlns) do
        path(
          :"fill-rule" => "evenodd",
    ...
    def home_icon
      svg(class: "w-5 h-5 mr-2.5", fill: "currentColor", viewBox: "0 0 20 20", xmlns: xmlns) do
        path(
    ...
    def arrow_icon
      svg(class: "w-6 h-6 text-gray-400", fill: "currentColor", viewBox: "0 0 20 20", xmlns: xmlns) do
        path(
          :"fill-rule" => "evenodd",
    ...
    def cross_icon
      svg(class: "w-5 h-5", fill: "currentColor", viewBox: "0 0 20 20", xmlns: xmlns) do
        path(
          :"fill-rule" => "evenodd",
