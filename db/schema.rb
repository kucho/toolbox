...
ActiveRecord::Schema[7.0].define(version: 2022_12_06_213433) do
  ...
  create_table("organization_active_sessions", force: :cascade) do |t|
    ...
    t.datetime("created_at", null: false)
    t.datetime("updated_at", null: false)
    t.index(["account_id"], name: "index_organization_active_sessions_on_account_id")
    t.index(["organization_id"], name: "index_organization_active_sessions_on_organization_id")
    t.index(["session_key_id"], name: "index_organization_active_sessions_on_session_key_id")
  end
